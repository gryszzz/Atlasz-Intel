...
export const INTELLIGENCE_SOURCES: IntelligenceSource[] = [
  ...
  source('fred-economic-data', 'FRED economic data', 'economic-data', 'Economic Data', 'https://fred.stlouisfed.org/', ['REST', 'CSV', 'JSON'], 'public-no-auth', 'runtime-wired', 'official-api', [], 'fred-macro', ['rates', 'inflation', 'employment', 'credit', 'liquidity'], 'Official FRED graph CSV runs without a key; optional FRED API key upgrades REST metadata. No synthetic macro observations.'),
  ...
  source('eia-public-bulk', 'U.S. EIA public bulk files', 'energy-intelligence', 'Grid & Power', 'https://www.eia.gov/opendata/bulkfiles.php', ['REST', 'JSON'], 'public-no-auth', 'runtime-wired', 'official-api', [], 'eia-bulk-public', ['oil/gas prices', 'petroleum stocks', 'electricity generation reference'], 'Official EIA bulk files. Runtime adapter is a bounded public reference subset only; it does not replace or unlock the authenticated EIA API/facility/grid connectors.'),
  ...
  source('congress-gov', 'Congress.gov', 'geopolitical-intelligence', 'Government Sources', 'https://www.congress.gov/', ['REST', 'JSON', 'HTML'], 'public-no-auth', 'runtime-wired', 'official-api', [], 'congress-gov', ['bills', 'committee actions', 'policy momentum', 'sector regulation'], 'Official Congress.gov API v3 source. Uses public DEMO_KEY mode by default; optional personal API key only raises quota. No political interpretation, person enrichment, or inferred company exposure.'),
  ...
  source('openalex-api', 'OpenAlex Works API', 'academic-research', 'Academic & Research', 'https://api.openalex.org/works', ['REST', 'JSON', 'Graph'], 'public-no-auth', 'runtime-wired', 'official-api', [], 'openalex-works', ['research works', 'institutions', 'topics', 'venues', 'citation metadata'], 'Official OpenAlex API. Public no-key mode runs by default; optional API key only raises quota. Metadata only; not validation of technical claims, breakthroughs, or market impact.'),
  source('crossref-rest-api', 'Crossref REST API', 'academic-research', 'Academic & Research', 'https://api.crossref.org/works', ['REST', 'JSON'], 'public-no-auth', 'runtime-wired', 'official-api', [], 'crossref-works', ['DOI metadata', 'publisher', 'venue', 'funder metadata', 'license metadata'], 'Official Crossref REST API. No key required; optional polite mailto is stripped from persisted URLs. Metadata only, not full text or claim validation.'),
