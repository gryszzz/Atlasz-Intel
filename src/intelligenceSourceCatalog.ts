...
export const INTELLIGENCE_SOURCES: IntelligenceSource[] = [
  ...
  source('congress-gov', 'Congress.gov', 'geopolitical-intelligence', 'Government Sources', 'https://www.congress.gov/', ['REST', 'JSON', 'HTML'], 'public-requires-key', 'runtime-wired', 'official-api', ['ATLASZ_CONGRESS_API_KEY'], 'congress-gov', ['bills', 'committee actions', 'policy momentum', 'sector regulation'], 'Official Congress.gov API v3 source. Requires configured API key for runtime and exact bill/source trails. No political interpretation, person enrichment, or inferred company exposure.'),
  ...
  source('openalex-api', 'OpenAlex Works API', 'academic-research', 'Academic & Research', 'https://api.openalex.org/works', ['REST', 'JSON', 'Graph'], 'public-requires-key', 'runtime-wired', 'official-api', ['ATLASZ_OPENALEX_API_KEY'], 'openalex-works', ['research works', 'institutions', 'topics', 'venues', 'citation metadata'], 'Official OpenAlex API. Requires a free API key and fails closed without it. Metadata only; not validation of technical claims, breakthroughs, or market impact.'),
