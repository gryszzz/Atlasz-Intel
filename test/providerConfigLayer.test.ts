...
describe('provider config layer', () => {
  it('loads built-ins and detects configuration honestly (fail-closed)', () => {
    ...
    expect(isProviderConfigured(find(providers, 'macro_calendar_fred'), {})).toBe(true)
    ...
    expect(isProviderConfigured(find(providers, 'eia_bulk_public'), {})).toBe(true)
    ...
    expect(isProviderConfigured(find(providers, 'congress_gov_public'), {})).toBe(true)
    expect(isProviderConfigured(find(providers, 'congress_gov_public'), { ATLASZ_CONGRESS_API_KEY: 'x' })).toBe(true)
    expect(isProviderConfigured(find(providers, 'openalex_works_public'), {})).toBe(true)
...
describe('adapter registry', () => {
  it('resolves reusable fetchers and fails closed on missing credentials', () => {
    ...
    expect(resolveAdapter(find(providers, 'macro_calendar_fred'), {}).fetcher).toBeTypeOf('function')
    expect(resolveAdapter(find(providers, 'macro_calendar_fred'), { ATLASZ_FRED_API_KEY: 'secret' }).fetcher).toBeTypeOf('function')
    ...
    expect(resolveAdapter(find(providers, 'eia_bulk_public'), {}).fetcher).toBeTypeOf('function')
    ...
    expect(resolveAdapter(find(providers, 'congress_gov_public'), {}).fetcher).toBeTypeOf('function')
    expect(resolveAdapter(find(providers, 'congress_gov_public'), { ATLASZ_CONGRESS_API_KEY: 'secret' }).fetcher).toBeTypeOf('function')
    expect(resolveAdapter(find(providers, 'openalex_works_public'), {}).fetcher).toBeTypeOf('function')
