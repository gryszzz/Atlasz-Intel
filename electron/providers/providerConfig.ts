...
export const BUILTIN_PROVIDERS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    provenance: 'official-api',
    legalSafetyNote:
      'Official EIA Open Data respondent facet (electricity/rto) — the U.S. balancing authority reference list. Grid operating-region reference only — never an outage/grid-stress/reliability/vulnerability claim. Requires ATLASZ_EIA_API_KEY; fail-closed without it. api_key never persisted.',
  },
  {
